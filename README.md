...
## 🛠️ Étapes pour participer

1. **Cloner le projet**
```bash
git clone https://github.com/mon-nom/projet-web.git
cd projet-web
```
...
3. **Faire ton travail** (ex: modifier index.html)
...
5. **Fusionner dans test**, puis dans `dev`, puis dans `main` une fois validé.
